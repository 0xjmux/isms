...
class zeitgeist(MapTile):
    def intro_text(self):
        ...
        The spirit of the times has shifted, and people appear much less happy than they did before. Wars and the great depression have had a great effect on the general mood of the people, 
        especially on the artists of the time. """
